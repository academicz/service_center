    ...
    <div id="navbar-container" class="boxed">
        ...
        <div class="navbar-header">
            <a href="{{ route('adminHome') }}" class="navbar-brand">
                <img src="{{ asset('admin/images/logo.png') }}" alt="E2CARE Logo" class="brand-icon">
                <div class="brand-title">
                    <span class="brand-text">E2CARE</span>
                </div>
            </a>
        </div>
        <!--================================-->
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-12 col-md-3">
                                ...
                                <ul class="list-unstyled list-inline text-justify">
                                    ...
                                    <li class="pad-btm">
                                        <img src="{{ asset('admin/images/thumbs/mega-menu-2.jpg') }}" alt="thumbs">
                                    </li>
                                    <li class="pad-btm">
                                        <img src="{{ asset('admin/images/thumbs/mega-menu-3.jpg') }}" alt="thumbs">
                                    </li>
                                    <li class="pad-btm">
                                        <img src="{{ asset('admin/images/thumbs/mega-menu-1.jpg') }}" alt="thumbs">
                                    </li>
                                    <li class="pad-btm">
                                        <img src="{{ asset('admin/images/thumbs/mega-menu-4.jpg') }}" alt="thumbs">
                                    </li>
                                    <li class="pad-btm">
                                        <img src="{{ asset('admin/images/thumbs/mega-menu-5.jpg') }}" alt="thumbs">
                                    </li>
                                    <li class="pad-btm">
                                        <img src="{{ asset('admin/images/thumbs/mega-menu-6.jpg') }}" alt="thumbs">
                                    </li>
                                </ul>
            ...
            <ul class="nav navbar-top-links pull-right">
                ...
                <li id="dropdown-user" class="dropdown">
                    <a href="#" data-toggle="dropdown" class="dropdown-toggle text-right">
                        ...
                        {{--<div class="username hidden-xs">{{ //$admin->name }}</div>--}}
                    </a>
                    ...
                    <div class="dropdown-menu dropdown-menu-md dropdown-menu-right panel-default">
                        ...
                        <div class="pad-all text-right">
                            <a href="{{ route('adminLogout') }}" class="btn btn-primary">
